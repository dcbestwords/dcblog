import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as p,c as i,a as s,b as a,d as l,r as c,e as o}from"./app--IULgkuy.js";const u={},d={href:"http://koala-app.com/index.html",target:"_blank",rel:"noopener noreferrer"},r={href:"https://juejin.cn/post/7116139958699556877#comment",target:"_blank",rel:"noopener noreferrer"};function v(k,n){const e=c("ExternalLinkIcon");return p(),i("div",null,[n[4]||(n[4]=s("h2",{id:"一、简介",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#一、简介"},[s("span",null,"一、简介")])],-1)),n[5]||(n[5]=s("p",null,"Less(Leaner Style Sheets 精简样式表) 是一种动态样式语言，属于 css 预处理器的范畴，它扩展了 CSS 语言，增加了变量、Mixin、函数等特性，使 CSS 更易维护和扩展，Less 既可以在 客户端 上运行 ，也可以借助 Node.js 在服务端运行。",-1)),n[6]||(n[6]=s("p",null,"Less 编译工具：",-1)),s("ul",null,[s("li",null,[s("a",d,[n[0]||(n[0]=a("Koala")),l(e)])]),n[1]||(n[1]=s("li",null,"vscode 的 Easy LESS 插件",-1))]),n[7]||(n[7]=o(`<h2 id="二、注释" tabindex="-1"><a class="header-anchor" href="#二、注释"><span>二、注释</span></a></h2><ul><li>多行注释会被保留</li><li>单行注释不被保留在编译生成的 CSS 中</li></ul><div class="language-less line-numbers-mode" data-ext="less" data-title="less"><pre class="language-less"><code><span class="token comment">/* 
 * 一个块注释
 * style comment! 
*/</span>

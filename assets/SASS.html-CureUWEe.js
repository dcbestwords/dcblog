import{_ as c}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as l,c as o,e,a as n,b as a,d as t,r as i}from"./app--IULgkuy.js";const u="/dcblog/assets/使用分析-rNI2xJZd.png",d={},r={href:"http://www.imooc.com/code/6957",target:"_blank",rel:"noopener noreferrer"},k={id:"_1-number",tabindex:"-1"},v={class:"header-anchor",href:"#_1-number"},m={href:"https://sass.bootcss.com/documentation/values/numbers.html",target:"_blank",rel:"noopener noreferrer"},b={id:"_2-string",tabindex:"-1"},g={class:"header-anchor",href:"#_2-string"},h={href:"https://sass.bootcss.com/documentation/values/strings.html",target:"_blank",rel:"noopener noreferrer"},y={id:"_3-color",tabindex:"-1"},x={class:"header-anchor",href:"#_3-color"},f={href:"https://sass.bootcss.com/documentation/values/colors.html",target:"_blank",rel:"noopener noreferrer"},w={id:"_4-list",tabindex:"-1"},$={class:"header-anchor",href:"#_4-list"},q={href:"https://sass.bootcss.com/documentation/values/lists.html",target:"_blank",rel:"noopener noreferrer"},S={id:"_5-boolean",tabindex:"-1"},_={class:"header-anchor",href:"#_5-boolean"},z={href:"https://sass.bootcss.com/documentation/values/booleans.html",target:"_blank",rel:"noopener noreferrer"},C={id:"_6-null",tabindex:"-1"},H={class:"header-anchor",href:"#_6-null"},T={href:"https://sass.bootcss.com/documentation/values/null.html",target:"_blank",rel:"noopener noreferrer"},L={id:"_7-map",tabindex:"-1"},N={class:"header-anchor",href:"#_7-map"},M={href:"https://sass.bootcss.com/documentation/values/maps.html",target:"_blank",rel:"noopener noreferrer"},A={id:"_8-function",tabindex:"-1"},R={class:"header-anchor",href:"#_8-function"},B={href:"https://sass.bootcss.com/documentation/values/functions.html",target:"_blank",rel:"noopener noreferrer"};function P(D,s){const p=i("ExternalLinkIcon");return l(),o("div",null,[s[17]||(s[17]=e(`<h2 id="一、sass简介" tabindex="-1"><a class="header-anchor" href="#一、sass简介"><span>一、Sass简介</span></a></h2><p>Sass 又名 SCSS 是 CSS 预处理器之一，诞生于2007年,采用 Ruby 语言编写的一款 CSS 预处理语言。最初它是为了配合 HAML（一种缩进式 HTML 预编译器）而设计的，因此有着和 HTML 一样的缩进式风格。</p><p>Sass 和 SCSS 其实是同一种东西，我们平时都称之为 Sass，两者之间不同之处有以下两点：</p><ol><li>文件扩展名不同，Sass 是以“.sass”后缀为扩展名，而 SCSS 是以“.scss”后缀为扩展名</li><li>语法书写方式不同，Sass 是以严格的 <mark>缩进式</mark> 语法规则来书写，不带大括号 {} 和分号 ; ，而 SCSS 的语法书写和 CSS 语法书写方式类似。</li></ol><hr><h2 id="二、sass与css写法的差异" tabindex="-1"><a class="header-anchor" href="#二、sass与css写法的差异"><span>二、Sass与CSS写法的差异</span></a></h2><p>由于 Sass 是基于 Ruby 写出来的所以沿用了 Ruby 的书写规范，不带有大括号 &quot; {} &quot;和分号&quot; ; &quot;</p><p>CSS的写法：</p><div class="language-css line-numbers-mode" data-ext="css" data-title="css"><pre class="language-css"><code><span class="token selector">body</span><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-全局变量和局部变量" tabindex="-1"><a class="header-anchor" href="#_3-全局变量和局部变量"><span>3. 全局变量和局部变量</span></a></h3>`,65)),n("p",null,[n("a",r,[s[0]||(s[0]=a("变量的调用")),t(p)])]),s[18]||(s[18]=e(`<div class="language-scss line-numbers-mode" data-ext="scss" data-title="scss"><pre class="language-scss"><code><span class="token property"><span class="token variable">$color</span></span><span class="token punctuation">:</span> yellow <span class="token statement keyword">!default</span><span class="token punctuation">;</span> <span class="token comment">//定义全局变量</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,8)),n("h3",C,[n("a",H,[n("span",null,[s[12]||(s[12]=a("6. ")),n("a",T,[s[11]||(s[11]=a("null")),t(p)])])])]),s[24]||(s[24]=e(`<p><code>null</code> 值也是该类型的唯一值。它表示没有值，通常由函数返回，表示没有结果。</p><div class="language-scss line-numbers-mode" data-ext="scss" data-title="scss"><pre class="language-scss"><code><span class="token keyword">@use</span> <span class="token string">&quot;sass:map&quot;</span><span class="token punctuation">;</span>
